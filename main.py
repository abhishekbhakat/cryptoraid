...
while True:
    ...
    if (
        ...
        and trader.wallet.paddle_2["current"] != {}
    ):
        ...
        if trader.wallet.paddle_1["previous"] != {}:
            while (
                ticker["last_price"]
                > trader.sudo_profit(
                    trader.wallet.paddle_1["previous"][
                        trader.config["main"]["target_symbol"]
                    ],
                    trader.wallet.paddle_1["previous"][
                        trader.config["main"]["source_symbol"]
                    ],
                )
            ) and (
                ticker["last_price"]
                ...
                logging.info(
                    "sleeping for {}".format(int(trader.config["main"]["interval"]))
                )
                ...
                if ticker["last_price"] > trader.sudo_profit(
                    trader.wallet.paddle_1["previous"][
                        trader.config["main"]["target_symbol"]
                    ],
                    trader.wallet.paddle_1["previous"][
        ...
        ticker = trader.ticker()
        while trader.profit(
            trader.wallet.paddle_2["current"][trader.config["main"]["target_symbol"]]
        ) < float(trader.config["main"]["profit"]):
            print(
                "Appx. profit = {}".format(
                    trader.profit(
            ...
            if trader.profit(
                ...
                trader.wallet.paddle_2["previous"][
                    trader.config["main"]["target_symbol"]
                ] = order["total_quantity"]
                trader.wallet.paddle_2["previous"][
                    trader.config["main"]["source_symbol"]
        ...
        trader.wallet.paddle_2["current"] == {}
        and trader.wallet.paddle_1["current"] != {}
    ):
        ...
        ticker = trader.ticker()
        while trader.profit(
            trader.wallet.paddle_1["current"][trader.config["main"]["target_symbol"]]
        ) < float(trader.config["main"]["profit"]):
            print(
                "Appx. profit = {}".format(
                    trader.profit(
