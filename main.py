...
welcome = text2art("Cryptoraid v{}".format(config['main']['version']))
...
while True:
    ...
    if trader.wallet.paddle_1['current'] == {} and trader.wallet.paddle_2['current'] != {}:
        ...
        if trader.wallet.paddle_1['previous'] != {}:
            while (ticker['last_price'] > trader.sudo_profit(trader.wallet.paddle_1['previous'][trader.config['main']['target_symbol']], trader.wallet.paddle_1['previous'][trader.config['main']['source_symbol']])) and (ticker['last_price'] < trader.wallet.paddle_1['previous'][trader.config['main']['target_symbol']]) :
                ...
                if ticker['last_price'] > trader.sudo_profit(trader.wallet.paddle_1['previous'][trader.config['main']['target_symbol']], trader.wallet.paddle_1['previous'][trader.config['main']['source_symbol']]) :
                    order = trader.buy()
        ...
        while trader.profit(trader.wallet.paddle_2['current'][trader.config['main']['target_symbol']]) < float(trader.config['main']['profit']) :
            ...
            print("Appx. profit = {}".format(trader.profit(trader.wallet.paddle_2['current'][trader.config['main']['target_symbol']])))
            if trader.profit(trader.wallet.paddle_2['current'][trader.config['main']['target_symbol']]) > float(trader.config['main']['profit']) :
        ...
        pprint(trader.wallet.paddle_2)
        if trader.wallet.paddle_1['previous'] != {}:
            while (ticker['last_price'] > trader.sudo_profit(trader.wallet.paddle_2['previous'][trader.config['main']['target_symbol']], trader.wallet.paddle_2['previous'][trader.config['main']['source_symbol']])) and (ticker['last_price'] < trader.wallet.paddle_2['previous'][trader.config['main']['target_symbol']]) :
                ...
                ticker = trader.falling_trend()
                if ticker['last_price'] > trader.sudo_profit(trader.wallet.paddle_2['previous'][trader.config['main']['target_symbol']], trader.wallet.paddle_2['previous'][trader.config['main']['source_symbol']]):
                    order = trader.buy()
